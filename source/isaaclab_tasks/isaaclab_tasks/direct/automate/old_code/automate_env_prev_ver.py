...
class AutomateEnv(DirectRLEnv):
    ...
    def _compute_intermediate_values(self, dt):
        ...
        print(f"self.held_pos: {self.held_pos[0]} -------- \n")
    ...
    def randomize_initial_state(self, env_ids):
        ...
        while True:
            ...
            # above_fixed_pos[:, 2] += self.cfg_task.fixed_asset_cfg.height # need to edit by SH
        ...
        translated_held_asset_quat, translated_held_asset_pos = torch_utils.tf_combine(
            q1=translated_held_asset_quat,translated_held_asset_pos
        ...
        print(f"init actions: {self.actions[0]} --------")