...
class AutomateEnvDisassembly1(DirectRLEnvAutomate):
    cfg: AutomateEnvCfg
    ...
    def _disassemble_plug_from_socket(self):
        ...
        self._lift_gripper(self.disassembly_dists)
        ...
        print(f"final joint pose: {self.joint_pos[:, 0:7]}")
    ...
    def _save_log_traj(self):
        ...
        if len(self.log_arm_dof_pos) > 100: # self.cfg_task.env.num_log_traj:
            ...
            # Need to edit (Add by Seunghwan Yu)
            log_filename = os.path.join(os.getcwd(), self.data_dir, 'asset_01132_disassembly_traj.json')
