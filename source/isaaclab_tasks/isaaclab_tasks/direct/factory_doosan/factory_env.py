...
class FactoryEnv(DirectRLEnv):
	...
	def _init_tensors(self):
		...
		# === _robot.body_names ===================================================================================================================================================================
		# --- 1) Manipulator (Doosan M0609)
		# idx:		0 	     1         2         3         4         5         6
		# 'base_link', 'link_1', 'link_2', 'link_3', 'link_4', 'link_5', 'link_6'
		# --- 2) Gripper (Robotiq 2F-85)
		# idx:               7                     8        9                    10                   11                    12                   13                     14                    15       
		# 'right_outer_knuckle', 'left_outer_knuckle', 'tool0', 'right_outer_finger', 'left_outer_finger', 'right_inner_finger', 'left_inner_finger', 'right_inner_knuckle', 'left_inner_knuckle'
		# =========================================================================================================================================================================================
		...
		# 'right_outer_knuckle_joint', 'finger_joint', 'right_outer_finger_joint', 'left_outer_finger_joint', 'right_inner_finger_joint', 'left_inner_finger_joint', 'right_inner_finger_knuckle_joint', 'left_inner_finger_knuckle_joint'
		# ==========================================================================================================================================================================================
	...
	def close_gripper_in_place(self):
		...
		# -- For accurate distance-to-angle proportionality, it should be divided by 1.8889, but for a safety margin, it is divided by 3.
		tmp_target_gripper_degree = 45-((self.cfg_task.held_asset_cfg.diameter*1e3)/3)
	...
	def _apply_action(self):
		...
		# self.ctrl_target_gripper_dof_pos = 0.0 #-np.pi/2 # 0.0
		self.generate_ctrl_signals()
	...
	def generate_ctrl_signals(self):
		...
		self.ctrl_target_joint_pos[:, 6] = self.ctrl_target_gripper_dof_pos

		# finger_joint 
		self.ctrl_target_joint_pos[:, 7] = self.ctrl_target_gripper_dof_pos

		# right_inner_finger_joint
		self.ctrl_target_joint_pos[:, 10] = self.ctrl_target_gripper_dof_pos

		# left_inner_finger_joint
		self.ctrl_target_joint_pos[:, 11] = -self.ctrl_target_gripper_dof_pos

		# right_inner_finger_knuckle_joint
		self.ctrl_target_joint_pos[:, 12] = -self.ctrl_target_gripper_dof_pos

		# left_inner_finger_knuckle_joint
		self.ctrl_target_joint_pos[:, 13] = -self.ctrl_target_gripper_dof_pos
	...
	def randomize_initial_state(self, env_ids):
		...
		while True:
			...
			self._set_franka_to_default_pose(
				# === Degrees of freedom change: 7 (panda) → 6 (doosan) ============
				joints=[0.0, 0.0, np.pi/2, 0.0, np.pi/2, 0.0], env_ids=bad_envs
				# ==================================================================
			)

			ik_attempt += 1
			print(f"ik_attempt: {ik_attempt} ---------\n")

		self.step_sim_no_action()

		# (3) Randomize asset-in-gripper location.
		# flip gripper z orientation (w, x, y, z)
		...
		# === Considering the operating speed of the Robotiq gripper, the actuation time has been increased fourfold (from 0.25 to 1.0). ===
		while grasp_time < 1.0:
			self.ctrl_target_joint_pos[env_ids, 6:] = 0.0
