...
class DirectRLEnvAutomate(gym.Env):
    ...
    def _post_physics_step(self):
        ...
        This function is responsible for post-processing the actions after stepping through the physics.
        It is called after the physics stepping (which is decimated).
