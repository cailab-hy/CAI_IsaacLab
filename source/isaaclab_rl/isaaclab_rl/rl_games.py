...
from isaaclab.envs import DirectRLEnv, DirectRLEnvAutomate, ManagerBasedRLEnv, VecEnvObs
...
class RlGamesVecEnvWrapper(IVecEnv):
    ...
    def __init__(self, env: ManagerBasedRLEnv | DirectRLEnv | DirectRLEnvAutomate, rl_device: str, clip_obs: float, clip_actions: float):
